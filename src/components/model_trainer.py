    ...
    def get_model_object_and_report(self, train: np.array, test: np.array) -> Tuple[object, object]:
        ...
        try:
            ...
            metric_artifact = ClassificationMetricArtifact(
                ...
                recall_score=recall,
                accuracy_score=accuracy  # Added accuracy score
            )
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        ...
        try:
            ...
            if train_accuracy < self.model_trainer_config.expected_accuracy:
                logging.info(f"Model accuracy {train_accuracy} is below the base score {self.model_trainer_config.expected_accuracy}")
